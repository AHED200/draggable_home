...
class DraggableHomeFullyCustomizable extends StatefulWidget {
  @override
  _DraggableHomeFullyCustomizableState createState() =>
      _DraggableHomeFullyCustomizableState();
...
class _DraggableHomeFullyCustomizableState
    extends State<DraggableHomeFullyCustomizable> {
  ...
  Widget build(BuildContext context) {
    ...
    // if (widget.scrollController?.hasListeners ?? false) {
    widget.scrollController?.addListener(() {
      if (widget.scrollController?.hasClients ?? false) {
        // isFullyCollapsed
        if ((isFullyExpanded.value) &&
            (widget.scrollController?.position.extentBefore ?? 0) > 100) {
